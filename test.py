...
def main():
	...
	parser.add_argument('--model_dir', type=str, default='trained_models/my_model_empty_arena', help='directory of the trained model')
	...
	parser.add_argument('--test_model', type=str, default='03000.pt')
