...
def main():
	...
	parser.add_argument('--model_dir', type=str, default='trained_models/sweep_empty_arena_x-axis', help='directory of the trained model')
	...
	parser.add_argument('--test_model', type=str, default='05000.pt')
